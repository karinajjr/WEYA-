...
function ComponyRegistration() {
    ...
    return (
        <div className="bg-[url('../../public/assets/Bg.png')] bg-no-repeat w-full flex justify-center items-center bg-cover bg-center h-full absolute top-0 right-0 left-0 bottom-0 bg-base-100 z-20">
            <div className='border border-black/12 bg-white rounded-2xl px-10 py-12 shadow w-[400px] md:w-[805px]'>
                ...
                <div className=" ">
                    ...
                    <div className={`grid grid-cols-1 md:grid-cols-2 gap-5 ${showInfo === true ? "hidden" : ""}`}>
                        <div className=''>
                        ...
                        <div className=''>
                            <p className='text-xs font-medium mb-1'>Ma’sul shaxsning ismi</p>
                            <label className="input w-full border-none bg-[#F7F8F9]">
                                <input type="text" className="grow" placeholder="Yozing" />
                            </label>
                        </div>
                        ...
                        <div className=''>
                            ...
                            <label className="input w-full border-none bg-[#F7F8F9]">
                                <input type="text" className="grow" placeholder="+998 90 000 00 00" />
                            </label>
                        </div>
                        ...
                        <div className=' '>
                            ...
                            <label className="input w-full border-none bg-[#F7F8F9]">
                                <input type="text" className="grow" placeholder="51723456" />
                            </label>
                        </div>
                    </div>

                    <div className={` grid grid-cols-1 md:grid-cols-2 gap-5 mt-3 ${showInfo === false ? "hidden" : ""}`}>
                        ...
                        <div className=' '>
                            <p className='text-xs font-medium mb-1'>Kompaniya xujjat raqami</p>
                            <label className="input w-full border-none bg-[#F7F8F9]">
                                <input type="text" className="grow" placeholder="00000000000" />
                            </label>
                        </div>
                        ...
                        <div className=' '>
                            <p className='text-xs font-medium mb-1'>Kompaniya web sayti</p>
                            <label className="input w-full border-none bg-[#F7F8F9]">
                                <i className="bi bi-envelope text-[#686868]"></i>
                                <input type="text" className="grow" placeholder="htps//misol.com" />
                            </label>
                        </div>

                        <div className='mb-3'>
                            <p className="text-xs font-medium mb-1">Parolingiz o’rnating</p>
                        ...
                        <div className='mb-3'>
                            <p className="text-xs font-medium mb-1">Parolingizni qayta tasdiqlang</p>
                            <label className="input w-full border-none bg-[#F7F8F9] flex items-center gap-2 px-3 py-2 rounded">
                                <i className="bi bi-lock text-[#686868]"></i>
                                <input type={showPassword ? 'text' : 'password'} className="grow bg-transparent outline-none" placeholder="Parol"/>
                                <button type="button" onClick={togglePassword} className="focus:outline-none">
                    ...
                    {showInfo !== true && (
                        <button onClick={toggleShowInfo} className="w-full mt-4 btn md:hidden bg-gradient-to-r from-[#8360C3] to-[#2EBF91] text-white">
                    ...
                    <div className={`flex justify-between gap-10 mt-3 ${showInfo === true ? "hidden" : ""}`}>
                        <p className='text-xs text-[#686868]'>Sizning hisobingiz mavjudmi?</p>
                        <p className="text-xs font-medium bg-gradient-to-r from-[#8360C3] to-[#2EBF91] bg-clip-text text-transparent">Hisobga kirish</p>
                    </div>
...
export default ComponyRegistration;
