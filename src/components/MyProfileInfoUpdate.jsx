      ...
      <dialog id="my_profile_info_update" className="modal">
        <div className="modal-box border border-gray-300 dark:border-gray-600 bg-base-200 bg-gradient-to-r from-[#eed9ed]/60 dark:from-[#eed9ed]/10 to-[#2ec05a]/10">
          ...
          <div className="items-start flex gap-4 mt-4">
            ...
            <div className=''>
              <div className='flex gap-2'>
                <button className="btn btn-sm bg-blue-400 border-0 rounded-full w-20">Upload</button>
                <button className="btn btn-sm bg-red-500 border-0 rounded-full w-20">Delete</button>
              </div>
          ...
          <div className=' flex gap-3 mt-2'>
            <button className="btn bg-blue-400 text-white ">Сохранить изменения</button>
            <form method="dialog">
              <button className="btn bg-gray-400 text-white ">Отменить</button>
            </form>
          </div>
        </div>
