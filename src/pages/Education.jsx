...
import il from "../../public/assets/il.png"
      ...
      <div className="container mx-auto px-3 text-gray-900 dark:text-gray-50">
        ...
        <div>
                ...
                <div className="p-6 flex justify-between items-center rounded-xl border border-gray-200 dark:border-gray-400 hover:bg-base-200">
                  ...
                  <div className="flex gap-3 items-center">
                    ...
                    <div>
                      ...
                      <p className="text-xs opacity-50 dark:opacity-90">Frontend Dev.</p>
                    </div>
                  </div>
          ...
          <div className="flex flex-col justify-center items-center">
            <h1 className="flex gap-1 text-2xl text-center font-medium uppercase">
              <span>Eng Ommabop yo‘nalishlar</span>
            </h1>

            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mt-8 w-full">
              {popular_des.map((item) => (
                <div className="p-5 flex justify-between items-center rounded-xl  hover:bg-base-200 border border-gray-200 dark:border-gray-400">
                  <div className="flex gap-3 items-center">
                    <i className={`${item.icon} text-[#0EA5E9] text-xl flex justify-center items-center`}></i>
          ...
          <div className="flex flex-col justify-center items-center my-12">
            <h1 className="flex gap-1 text-2xl text-center font-medium uppercase">
              <span> WeYa+ qanday ishlaydi?</span>
            </h1>

            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5 mt-8 ">
              <div className="rounded-2xl p-5 hover:bg-base-200 border border-gray-200 dark:border-gray-400 ">
                <div className="flex flex-wrap justify-between relative">
                  <p className="font-semibold w-[80%] h-15">
                    O'zingizga mos masterklassni tanlaysiz.
                  </p>
                  <div className="text-5xl font-semibold mr-1 absolute right-0 top-0 text-[#0EA5E9]">
                    01
                  </div>
                </div>
          ...
          <div className="flex flex-col justify-center items-center w-full">
            <h1 className="flex gap-1 text-2xl text-center font-medium uppercase">
              <span>Platforma  Ko‘rsatkichlari</span>
            </h1>

            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 mt-8 w-full">
              <div className="rounded-2xl py-8 flex flex-col justify-center items-center  hover:bg-base-200 border border-gray-200 dark:border-gray-400">
                <p className="font-bold text-xl">Umumiy o'quvchilar soni</p>
                <span className="text-4xl font-extrabold mt-2 text-[#0EA5E9]">+12,265</span>
              </div>

              <div className="rounded-2xl py-8 flex flex-col justify-center items-center  hover:bg-base-200 border border-gray-200 dark:border-gray-400">
                <p className="font-bold text-xl">Yozilgan darslar soni</p>
                <span className="text-4xl font-extrabold mt-2 text-[#0EA5E9]">+265</span>
              </div>

              <div className="rounded-2xl py-8 flex flex-col justify-center items-center hover:bg-base-200 border border-gray-200 dark:border-gray-400 ">
                <p className="font-bold text-xl">O'rtacha jamoaviy tajribaa</p>
                <span className="text-4xl font-extrabold mt-2 text-[#0EA5E9]">+7 yil</span>
              </div>
            </div>
          </div>
          {/* ------------------- */}
