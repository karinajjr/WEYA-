...
const categories = ["UI design", "Frontend", "Mobile Developer", "Graphic design", "Backend", "UX design"];
      ...
      <div className="flex flex-col justify-center items-center ">
        ...
        <div className="flex justify-center items-center gap-5 my-5  px-2 py-1 rounded-2xl shadow-none border-0 bg-white/95 backdrop-sepia-0  bg-gradient-to-r from-[#eed9ed]/50 to-[#2ec05a]/20  h-[50px]">
          {categories.map((category) => (
            <button key={category} className={` px-2 py-1 border rounded-full ${selectedCategory === category
              ? "btn-primary-edu" : "btn-primary-edu"}`} onClick={() => setSelectedCategory(category)} >{category}
            </button>
          ))}
            ...
            .map((course) => (
              <div key={course.id} className="border border-[#CCCCCC] rounded-lg shadow-lg backdrop-sepia-0 bg-gradient-to-r bg-white/95  from-[#2ec05a]/30 to-[#eed9ed]/70 ">
                ...
                <div className="p-3 mb-2">
                  ...
                  <p className="text-sm font-medium"> Number of lessons: {course.lessons}</p>
                  <div className="flex justify-evenly mt-6 ">
                    <button className="px-8 py-1 font-medium rounded-full border border-black  bg-white/95 backdrop-sepia-0  bg-gradient-to-r from-[#eed9ed]/50 to-[#2ec05a]/40  ">TO BUY</button>
                    <button className="px-6 py-1 font-medium rounded-full border border-black  bg-white/95 backdrop-sepia-0  bg-gradient-to-r from-[#eed9ed]/50 to-[#2ec05a]/40 ">READ MORE</button>
                  </div>
                </div>
      ...
      <div className="flex flex-col justify-center items-center mt-18">
        ...
        <div className="flex items-center justify-center w-[100%] mt-20 mb-20">
          <div className="relative  px-10 py-6 rounded-3xl shadow-lg text-center w-full  mt-5 border border-[#CCC] bg-gradient-to-r from-[#eed9ed]/70 to-[#2ec05a]/30 ">
            ...
            <h1 className="text-4xl font-medium mt-22 text-black ">Start building your <br /> future now!</h1>
