  ...
  return (
    <>
      ...
      <div className="container mx-auto px-3 items-start flex gap-4 mt-4 text-gray-900 dark:text-gray-50 ">
        {/* Левая панель */}
        <div className={`w-3/3 lg:w-1/3 rounded-2xl p-4 shadow bg-white dark:bg-slate-800 ${view === "right" ? "hidden" : "block"}`}>
              ...
              <div className="collapse collapse-arrow bg-slate-100 dark:bg-slate-950 ">
                ...
                <div className="collapse-title  flex gap-2 ">
                  <div className="flex items-center justify-center relative h-[45px] w-[45px]">
                    <div className="radial-progress text-gray-100 h-[45px] w-[45px] absolute [--thickness:3px] noround"
                      style={{ "--value": 100, }}>
                    </div>
        ...
        {/* Правая часть */}
        <div className={`w-3/3 lg:w-2/3 shadow p-4 rounded-2xl backdrop-blur bg-white dark:bg-slate-800 ${view === "left" ? "hidden" : "block"}`}>
          <div className="flex justify-between items-center mb-4 ">
            <div>
          ...
          <div className="tabs tabs-border mt-4">
            <input type="radio" name="my_tabs_2" className="tab" aria-label="Q&A" />
            <div className="tab-content border-t-slate-100 py-2 ">
              <div className="flex  justify-between items-center mt-6">
                <div>
                  ...
                  <div className="flex text-xs text-slate-500 dark:text-slate-100 gap-8 mt-3">
                    <p> <i class="bi bi-question-circle text-sky-500 mr-1"></i> Savollar 20ta</p>
                    <p> <i class="bi bi-envelope  text-sky-500 mr-1.5"></i>Javoblar 17ta </p>
                  </div>
                </div>
                <button className="btn f border-none bg-sky-500 text-white">Savol so’rash</button>
              </div>
              ...
              <div className="flex mt-4 items-center">
                <label className="input w-full bg-slate-50 dark:bg-slate-950 border-none">
                  ...
                  <input type="search" className="grow placeholder:text-slate-500 dark:placeholder:text-slate-100" placeholder="Savollaringizni qidiring" />
                </label>
              ...
              <div className="mt-3 ">
                ...
                <div className="border border-slate-50 dark:border rounded-xl p-4 mt-2">
                  ...
                  <div className="bg-slate-50 dark:bg-slate-950 py-2 px-3 mt-4">
                    ...
                    <p className="text-xs mt-3">Savolim video ko'rib pytonni o'rganaman deb kirgan odam mayli kirish qismida 1ta video bor ekan ilk qadamlarda kerakli qurilmalarni odam qayerdan bilib olishi mumkin bu menga qiziq yani kerakli dasturlarni </p>
                  </div>
                  ...
                  <div className="flex items-center justify-end mt-3">
                    <h1 className="text-sky-500 text-sm">Yana 4ta javobni ko’rish  <i className="bi bi-chevron-down ml-2"></i></h1>
                  </div>
                </div>
              </div>
            </div>

            <input type="radio" name="my_tabs_2" className="tab" aria-label="Materiallar" defaultChecked />
            <div className="tab-content border-t-slate-100  py-3 font-medium text-xl">Materiallar
              <p className="text-sm font-light mt-2">Amaliyot uchun havola <span className="text-sky-500">Ustiga bosing</span></p>
            </div>
              ...
              <div className="mt-5">
                ...
                <div className="border border-slate-50 dark:border-slate-100 rounded-xl p-3 mt-2">
                  ...
                  <div className="bg-slate-50 dark:bg-slate-950 py-2 px-3 ">
                    ...
                    <p className="text-xs mt-3">Assalomu alaykum platformaga gap yo’q weya hamjamiyatiga rahmat</p>
                  </div>
                </div>
              </div>
            </div>
